...
<div>
        <div className="flex gap-16  px-12 pt-12 flex-row ">
            <div>
                <div>
                 <Link href=""> <Image src = "/nancy.png"width={250} height={260} alt="nancy"/></Link>
                </div>
            ...
            <div>
                <div>
                 <Link href=""> <Image src = "/2.png"width={250} height={260} alt="nancy"/></Link>
                </div>
                <div className="pt-2 flex-col">
            ...
            <div>
                <div>
                 <Link href=""> <Image src = "/3.png"width={250} height={260} alt="nancy"/></Link>
                </div>
                <div className="pt-2 flex-col">
            ...
            <div>
                <div>
                 <Link href=""> <Image src = "/4.png"width={250} height={260} alt="nancy"/></Link>
                </div>
                <div className="pt-2 flex-col">
        ...
        <div>
                <div>
                   <Link href=""> <Image src = "/5.png"width={250} height={260} alt="nancy"/></Link>
                </div>
                <div className="pt-2 flex-col">
            ...
            <div>
                <div>
                 <Link href="" ><Image src = "/6.png"width={250} height={260} alt="nancy"/></Link>  
                </div>
                <div className="pt-2 flex-col">
            ...
            <div>
                <div>
                   <Link href=""> <Image src = "/7.png"width={250} height={260} alt="nancy"/></Link>
                </div>
                <div className="pt-2 flex-col">
            ...
            <div>
                <div>
                   <Link href=""> <Image src = "/8.png"width={250} height={260} alt="nancy"/></Link>
                </div>
                <div className="pt-2 flex-col">
        ...
        <div className=" pt-12 px-12">
                <div>
                   <Link href=""> <Image src = "/9.png"width={250} height={260} alt="nancy"/></Link>
                </div>
                <div className="pt-2 flex-col">
